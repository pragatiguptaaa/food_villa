    ...
    return (
        <div className="restaurantCard">
            <img alt ="Burger king image"
                src= {"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+restaurantData?.cloudinaryImageId} ></img>
            <h2> {restaurantData?.name} </h2>
            <h3 style ={{wordWrap:'break-word'}}> {restaurantData?.cuisines.join(",")} </h3>
...
const Body = () =>{
    ...
    <div className="restaurant-list">
        <RestaurantCard restaurantData = {restaurantList[0].data}/>
        <RestaurantCard restaurantData = {restaurantList[1].data}/>
        <RestaurantCard restaurantData = {restaurantList[2].data}/>
    </div>);
};
