    ...
    return (
        <div className="restaurantCard">
            <img alt ="Burger king image"
                src= {"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+restaurant.data?.cloudinaryImageId} ></img>
            <h2> {restaurant.data?.name} </h2>
            <h3 style ={{wordWrap:'break-word'}}> {restaurant.data?.cuisines.join(",")} </h3>
